...
struct Graphics {
    ...
    static void DrawPolygon(int x, int y, const std::vector<Vec2>& verticles, Uint32 color);
    static void DrawFillPolygon(int x, int y, const std::vector<Vec2>& verticles, Uint32 color);
